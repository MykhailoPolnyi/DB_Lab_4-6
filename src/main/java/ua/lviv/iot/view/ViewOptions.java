...
public class ViewOptions {
    ...
    private void setAvailableEntities() {
        ...
        availableEntities.put("machine-model", MachineModel.class);
        availableEntities.put("machine-producer", MachineProducer.class);
        availableEntities.put("machine-service", MachineService.class);
        availableEntities.put("snack-machine", SnackMachine.class);
    }
    ...
    private void setTableControllers() {
        ...
        tableControllers.put("machine-model", new MachineModelController());
        tableControllers.put("machine-producer", new MachineProducerController());
        tableControllers.put("machine-service", new MachineServiceController());
        tableControllers.put("snack-machine", new SnackMachineController());
    }
}
